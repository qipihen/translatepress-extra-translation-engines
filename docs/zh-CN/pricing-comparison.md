...
> 下表统一展示“优惠价 / 原价 / 折扣 / 并发”四个维度，便于快速选型。
...
## 5. 具体场景：AI 翻译何时比 Google Translate v2 / DeepL 更好

| 业务场景 | 更推荐 | 为什么 AI 更优（相对 Google v2 / DeepL） | 成本建议 |
|---|---|---|---|
| 营销落地页、本地化广告文案 | AI | 可控语气、品牌风格、转化导向表达 | 只对高价值页面启用 AI，其他页面继续机翻 |
| 带产品术语的技术文档 | AI | 可通过提示词强制术语一致，降低术语漂移 | 先做术语词表，再分批翻译 |
| 用户评论、论坛、口语化内容 | AI | 对缩写、错别字、网络语理解更稳 | AI 优先，但抽样复核敏感内容 |
| UI 微文案（按钮、弹窗、空状态） | AI | 能依据上下文输出更自然的短句 | 保留占位符规则，防变量损坏 |
| 海量参数表、SKU 描述、低价值页 | Google v2 / DeepL | 这类内容不强调风格，机翻吞吐与稳定性更合适 | 先机翻，必要时对重点页二次 AI 润色 |

一句话判断：

- 追求“语气、风格、上下文一致性”时，AI 翻译通常优于 Google Translate v2 / DeepL。
- 追求“最低成本、最高吞吐、可接受直译风格”时，Google Translate v2 / DeepL 更合适。
